...
dropdownMenu1.addEventListener('mouseleave', () => {dropdownMenu1.classList.remove('active-dropdown-menu')})
dropdownMenu2.addEventListener('mouseleave', () => {dropdownMenu2.classList.remove('active-dropdown-menu')})
dropdownMenu3.addEventListener('mouseleave', () => {dropdownMenu3.classList.remove('active-dropdown-menu')})
